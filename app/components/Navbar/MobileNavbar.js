...
export const MobileNavbar = ({ isOpen, handleClose }) => {
  useEffect(() => {
    const handleResize = () => {
...
const MobileDropdown = ({ title, items, handleClose }) => {
  ...
  return (
    <div
      ...
      className={`${
        isOpen ? "bg-midBlack" : ""
      } px-4 py-4 rounded-lg hover:cursor-pointer transition-all duration-500`}
    >
